...
import { colorPrimary, colorPrimaryLight } from "../../Components/colors";
...
export default class BookingDetail extends Component {
  ...
  async GetData() {
    ...
    getBookingDetailAction(bookingDetailData, Token).then((responseJson) => {
      if (responseJson.isError == false) {
        ...
        let p_date =
          responseJson.result.booking_details[0].pickup_date.split("-");
        let p_df = p_date[2] + "-" + p_date[1] + "-" + p_date[0];
        let pickup_datetime = moment(
          p_df +
            " " +
            responseJson.result.booking_details[0].pickup_time.split(" ")[0]
        );
        ...
        this.setState({
          ...
          pickup_tour_booking_details:
            responseJson.result.pickup_tour_booking_details[0],
          intransit_tour_booking_details:
            responseJson.result.intransit_tour_booking_details[0],
          delivered_tour_booking_details:
            responseJson.result.delivered_tour_booking_details[0],
  ...
  async goToBookong() {
    await AsyncStorage.setItem(
      "booking_details",
      JSON.stringify(this.state.booking_details)
    );
  ...
  render() {
    ...
    const intransit_tour_booking_details =
      this.state.intransit_tour_booking_details;
    const delivered_tour_booking_details =
      this.state.delivered_tour_booking_details;
            ...
            <View style={styles.BookingDetailContainer}>
              ...
              <View style={styles.InnerContainer}>
                <View style={styles.TopLabelContainer}>
                  <Image
                    ...
                    source={require("../../images/booking-list-icon/truck-50x50.png")}
                    style={styles.icon}
                  />
                ...
                <View style={styles.TopLabelContainer}>
                  <Image
                    style={styles.LabelIcon}
                    source={require("../../images/booking-list-icon/Rupee-50x50.png")}
                    style={styles.icon}
                  />
                  <Text style={styles.TopLabelName}>
                    {booking_details.quotation_status == 0 ? (
                      "Pending"
                    ) : (
                      <Text style={styles.LabelName}>
                        {booking_details.fare}/-
                      </Text>
                    )}
                  </Text>
                </View>
              ...
              <View style={styles.ItemContainer}>
                <View style={styles.ItemDetailContainer}>
                  ...
                  <View style={styles.LabelContainer}>
                    <Text style={styles.LabelName}>
                      {booking_details.commodity_weight}{" "}
                      {booking_details.weight_unit} |{" "}
                      {booking_details.packaging_type}
                    </Text>

                    {booking_details.packaging_type == "Gunny bags" ||
                    booking_details.packaging_type == "Loose" ||
                    booking_details.packaging_type == "others" ? (
                      <Text style={styles.LabelName}>
                        V: {booking_details.commodity_whole_volume}
                        {booking_details.volume_unit}{" "}
                      </Text>
                    ) : (
                      <Text style={styles.LabelName}>
                        L: {booking_details.commodity_length}
                        {booking_details.length_unit} | B:{" "}
                        {booking_details.commodity_breadth}
                        {booking_details.breadth_unit} | H:{" "}
                        {booking_details.commodity_height}
                        {booking_details.height_unit}
                      </Text>
                    )}

                    {booking_details.instruction ? (
                      <Text style={styles.LabelName}>
                        {booking_details.instruction}
                      </Text>
                    ) : null}
                    {booking_details.pickup_flexible_time ? (
                      <Text style={styles.LabelName}>
                        Pickup Time Flexibility :{" "}
                        {booking_details.pickup_flexible_time}
                      </Text>
                    ) : null}
                    {booking_details.dropoff_flexible_time ? (
                      <Text style={styles.LabelName}>
                        Drop-off Time Flexibility :{" "}
                        {booking_details.dropoff_flexible_time}
                      </Text>
                    ) : null}
                  </View>
                ...
                <View style={styles.ItemImageContainer}>
                  <Image
                    ...
                    source={{ uri: booking_details.consignment_image }}
                  />
                </View>
              </View>
              <View style={styles.PicAddressContainer}>
                <View style={styles.Address}>
                  ...
                  <View style={styles.AddressContainer}>
                    <Text numberOfLines={5} style={styles.addressText}>
                ...
                <View style={styles.PicDateTimeContainer}>
                  <Image
                    source={require("../../images/booking-list-icon/Calendar50x50.png")}
                    style={styles.icon}
                  />
              ...
              <View style={styles.PicAddressContainer}>
                <View style={styles.Address}>
                  ...
                  <View style={styles.AddressContainer}>
                    <Text numberOfLines={5} style={styles.addressText}>
                      {booking_details.dropoff_location}
                    </Text>
                  </View>
                </View>
                <View style={styles.PicDateTimeContainer}>
                  ...
                  <Text style={styles.date}>
                    {booking_details.dropoff_date}
                  </Text>
                  <Text style={styles.date}>
                    {booking_details.dropoff_time}
                  </Text>
                </View>
              </View>
                    ...
                    <View>
                      {delivered_tour_booking_details != null ? (
                        ...
                        <View>
                          ...
                          <Image
                            source={require("../../images/booking-list-icon/1-Grey.png")}
                            style={styles.trackImg}
                          />
                        </View> ? (
                        <View>
                      ...
                      {delivered_tour_booking_details != null ? (
                        <View>
                          <View>
                            ...
                            <Text style={styles.pickupDateTimeText}>
                              {pickup_tour_booking_details.date} |{" "}
                              {pickup_tour_booking_details.time}
                            </Text>
                          </View>
                          <View>
                            ...
                            <Text style={styles.pickupDateTimeText}>
                              {intransit_tour_booking_details.date} |{" "}
                              {intransit_tour_booking_details.time}
                            </Text>
                          </View>
                          <View>
                            <Text style={styles.deliveredTitle}>Delivered</Text>
                            <Text style={styles.pickupDateTimeText}>
                              {delivered_tour_booking_details.date} |{" "}
                              {delivered_tour_booking_details.time}
                            </Text>
                          </View>
                        </View>
                      ) : intransit_tour_booking_details != null ? (
                        <View>
                          ...
                          <View>
                            <Text style={styles.deliveredTitleGrey}>
                              Delivered
                            </Text>
                            <Text style={styles.pickupDateTimeTextGray}>
                              Pending
                            </Text>
                          </View>
                        </View>
                        ...
                        <View>
                          ...
                          <View>
                            <Text style={styles.inTransitTitleGrey}>
                              In Transit
                            </Text>
                            <Text style={styles.pickupDateTimeTextGray}>
                              Pending
                          ...
                          <View>
                            <Text style={styles.pickupTitleGrey}>
                              Picked Up
                            </Text>
                            <Text style={styles.pickupDateTimeTextGray}>
                              Pending
              ...
              {driver_vehicle_detail == null ? (
                ...
                <View style={styles.InnerContainerdriver}>
                  <View>
                    <Text style={styles.bookingtrack}>
                  ...
                  <View style={styles.TopLabelContainerpay}>
                    <View style={{ flexDirection: "row", flex: 1 }}>
                      ...
                      <Text style={styles.TopLabelNameValue}>
                        {driver_vehicle_detail.vehicle_no}
                      </Text>
                    </View>
                    <View style={{ flexDirection: "row" }}>
                      <Text style={styles.TopLabelName}>Vehicle Model</Text>
                      <Text style={styles.TopLabelNameValue}>
                        {driver_vehicle_detail.vehicle_model}
                      </Text>
                    </View>
                    <View style={{ flexDirection: "row" }}>
                      <Text style={styles.TopLabelName}>Driver Name</Text>
                      <Text style={styles.TopLabelNameValue}>
                        {driver_vehicle_detail.driver_name}
                      </Text>
                    </View>
                    <View style={{ flexDirection: "row" }}>
                      <Text style={styles.TopLabelName}>
                      ...
                      <Text style={styles.TopLabelNameValue}>
                        {driver_vehicle_detail.driver_mobile}
                      </Text>
                    </View>
                  </View>
                </View>
                ...
                <View style={styles.InnerContainerPayment}>
                  ...
                  <View style={styles.TopLabelContainerpay}>
                    <View style={{ flexDirection: "row" }}>
                      ...
                      <Image
                        style={styles.LabelIcon}
                        source={require("../../images/booking-list-icon/Rupee-22x22.png")}
                      />
                      <Text style={styles.TopLabelNameValue}>
                        {quo_payment.fare} /-
                      </Text>
