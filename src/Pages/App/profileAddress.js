          ...
          <ScrollView style={{ flexGrow: 1 }}>
            <Row style={{ height: "45%" }}>
              <Col style={{ marginBottom: "30%" }}>
                ...
                <View style={styles.TwoInputTogether}>
                  {this.state.city_Err ? (
                    <Text style={styles.errorcity}>{this.state.city_Err}</Text>
                  ) : null}
                  {this.state.pincode_Err && this.state.city_Err ? (
                    <Text style={styles.errorleft}>
                      {this.state.pincode_Err}
                    </Text>
                  ) : this.state.pincode_Err ? (
                    <Text style={styles.errorright}>
                      {this.state.pincode_Err}
                    </Text>
                  ) : null}
                </View>
                      ...
                      >
                        ...
                        >
                          <TextInput
                            ...
                            onChangeText={(sDValue) =>
                              this.searchDropoffAddress(sDValue)
                            }
