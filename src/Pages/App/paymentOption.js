          ...
          <View style={styles.container}>
            <View style={styles.form}>
              <View style={styles.control}>
                ...
                {this.state.account_holder_name_Err ? (
              ...
              <View style={styles.control}>
                ...
                {this.state.bank_name_Err ? (
                  <Text style={styles.error}>{this.state.bank_name_Err}</Text>
                ) : null}
              </View>
              <View style={styles.control}>
                <View style={styles.combine}>
                ...
                {this.state.branch_name_Err ? (
                  <Text style={styles.error}>{this.state.branch_name_Err}</Text>
                ) : null}
              </View>
              <View style={styles.control}>
                <View style={styles.combine}>
                ...
                {this.state.ifsc_code_Err ? (
                  <Text style={styles.error}>{this.state.ifsc_code_Err}</Text>
                ) : null}
              </View>
              ...
              <View style={styles.control}>
                ...
                {this.state.upi_id_Err ? (
                  <Text style={styles.error}>{this.state.upi_id_Err}</Text>
                ) : null}
              </View>
            </View>
          </View>
