...
import { View, StyleSheet, Image, Text, TouchableOpacity, AsyncStorage, ScrollView } from 'react-native';
		...
		return (
			<View style={styles.sideMenuContainer}>
				<TouchableOpacity onPress={this.toggleDrawer.bind(this)}
					...
					<Image source={require('../../images/menu-icon/Close-100x100.png')}
				...
				<View style={styles.sideMenuItemContainer}>
					<ScrollView>
						{this.items.map((item, key) => (
							<TouchableOpacity key={key} onPress={() => { this.props.navigation.navigate(item.screenToNavigate); }}>
								<View style={styles.itemRow} >
									<View style={{ flex: 1, flexDirection: 'row' }}>
										<View style={styles.itemIconContainer}>
											<Image source={MenuIcon[item.navOptionThumb]} style={styles.itemIcon} />
										</View>
									...
									<View style={styles.itemLeftArrowContainer}>
										<Image source={require('../../images/menu-icon/Right-Arrow.png')}
