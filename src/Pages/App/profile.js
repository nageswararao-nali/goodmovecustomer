...
import { StyleSheet, ActivityIndicator, View, AsyncStorage, RefreshControl, TextInput, Text, Image, TouchableOpacity, Keyboard, ScrollView, KeyboardAvoidingView } from 'react-native';
					...
					<ScrollView style={{flex: 1 ,}}>
						<View style={styles.form}>
							<View style={styles.control}>
									...
									{this.state.name_Err ? <Text style={styles.error}>{this.state.name_Err}</Text> : null}
								</View>
								<View style={styles.control}>
									...
									{this.state.companyName_Err ? <Text style={styles.error}>{this.state.companyName_Err}</Text> : null}
								</View>
								<View style={styles.control}>
									<View style={styles.combine}>
									...
									{this.state.companyType_Err ? <Text style={styles.error}>{this.state.companyType_Err}</Text> : null}
								</View>
								<View style={styles.control}>
									<View style={styles.combine}>
								...
								<View style={styles.control}>
									...
									{this.state.password_Err ? <Text style={styles.error}>{this.state.password_Err}</Text> : null}
								</View>
