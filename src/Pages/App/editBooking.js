...
class EditBooking extends Component {
    ...
    async submit() {
        ...
        formData.append('receiver_name', this.state.receiver_name ? this.state.receiver_name : 'test');
        // formData.append('receiver_contact', this.state.mobile);
        formData.append('receiver_contact', this.state.mobile ? this.state.mobile : '1234567891');
...
export default withNavigation(EditBooking);
