...
import { StyleSheet, ScrollView, View, TextInput, Text, Image, TouchableOpacity, Keyboard, KeyboardAvoidingView, ActivityIndicator } from 'react-native';
...
export default class Signup extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            company_type: '', company_typeError: '',
            mobile: '', mobileError: '',
    ...
    async register() {
        ...
        const { name, company_name, company_type, mobile, password, confirm_password } = this.state;
        ...
        if (!result) {
            ...
            var response = storeOTPAction(signupData).then(function (responseJson) {
                ...
                if (responseJson.isError == false) {
                    sendOTPAction(mobile).then(function (responseJson) {
                        ...
                        <View style={styles.container}>
                            ...
                            <View style={styles.loginbox}>
                                <View style={styles.loginlogo}>
                                    <Image source={require('../../images/Registration.png')} style={styles.login}></Image>
                                </View>
                                <View style={styles.input}>
                                    <Image source={require('../../images/User-name.png')} style={styles.textimage}></Image>
                                ...
                                <View style={styles.input}>
                                    <Image source={require('../../images/Company.png')} style={styles.textimage}></Image>
                                    <TextInput style={styles.textbox}
                                ...
                                <View style={styles.input}>
                                    <Image source={require('../../images/Call.png')} style={styles.textimage}></Image>
                                    <TextInput style={styles.textbox}
                                ...
                                <Text style={styles.error}>{this.state.confirm_passwordError}</Text>
                                ...
                                <View style={{ flexDirection: 'row', marginTop: 5, justifyContent: 'center' }}>
                                    ...
                                    <TouchableOpacity onPress={() => navigate('Login')}><Text style={styles.signup}> Login</Text></TouchableOpacity>
                                </View>
                            </View>
