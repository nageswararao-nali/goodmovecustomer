...
import { StyleSheet, View, ActivityIndicator, TextInput, Text, Image, TouchableOpacity, Keyboard, ScrollView } from 'react-native';
                        ...
                        <View style={styles.container}>
                            ...
                            <View style={styles.loginbox}>
                                <View style={styles.loginlogo}>
                                    <Image source={require('../../images/Forget-Password.png')} style={styles.login}></Image>
                                </View>

                                <View style={styles.content}>
                                    <Text style={styles.intro}>Enter Your Mobile Number Used During Registration</Text>
                                </View>
