...
import { storeOTPAction, VerityOTPAction, verifyMSGOTPAction, sendOTPAction, resendOTPAction } from '../../util/action';
...
export default class Otp extends Component {
    ...
    async submit() {
        ...
        if (aValue != '' && bValue != '' && cValue != '' && dValue != '') {
			...
			var response = verifyMSGOTPAction(mobile,enteredOTP).then(function (responseJson) {
                console.log(responseJson);
				if (responseJson.type == "success") {
                    /* API code for set new password */
					var response1 = VerityOTPAction(setData).then(function (responseJson) {
						console.log(responseJson);
                        ...
                        <View style={styles.container}>
                            ...
                            <View style={styles.loginbox}>
                                <View style={styles.loginlogo}>
                                    <Image source={require('../../images/OTP-Verification.png')} style={styles.login}></Image>
                                </View>
