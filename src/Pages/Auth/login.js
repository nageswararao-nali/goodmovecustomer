...
import { StyleSheet, View, ActivityIndicator, AsyncStorage, TextInput, Text, Image, TouchableOpacity, Keyboard, ScrollView, KeyboardAvoidingView } from 'react-native';
...
export default class Login extends Component {
    ...
    async login() {
        ...
        Keyboard.dismiss();
        const result = validate({ mobile: this.state.mobile, password: this.state.password }, constraints);
                        ...
                        <View style={styles.container}>
                            ...
                            <View style={styles.loginbox}>
                                ...
                                <View style={styles.input}>
                                    ...
                                    {this.state.passwordshow ? (<TouchableOpacity style={{ alignItems: 'flex-end' }}
                                        onPress={this.getPasswordshow}>
                                        <Image source={require('../../images/Eye.png')}
                                            style={styles.textimage}></Image>
                                    </TouchableOpacity>) : (<TouchableOpacity style={{ alignItems: 'flex-end' }}
                                        onPress={this.getPasswordshow}>
                                        <Image source={require('../../images/Eye-Close.png')}
                                            style={styles.textimage}></Image>
                                    </TouchableOpacity>)}
                                </View>
                                ...
                                <View style={{ flexDirection: 'row', marginTop: 5, justifyContent: 'center' }}>
                                    ...
                                    <TouchableOpacity onPress={() => navigate('Signup')}><Text style={styles.signup}> Register</Text></TouchableOpacity>

                                </View>
                            </View>
                        </View>
                        <View style={{flex:1, justifyContent: 'center', alignItems: 'center'}}><Text>Version 1.1.6</Text></View>
                    </ScrollView>
